package be.ac.ulg.geofencingnotifications;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void populateGeofenceList() {
        for (Map.Entry<String, LatLng> entry : Constants.BAY_AREA_LANDMARKS.entrySet()) {
            ...
            mGeofenceList.add(new Geofence.Builder()
                    ...
                    // Create the geofence.
                    .build());
            Toast.makeText(this, "Geofence List Poblada " + mGeofenceList.size() + " elementos", Toast.LENGTH_SHORT).show();
    ...
    public void addGeofencesButtonHandler(View view) {
        ...
        Toast.makeText(this, getString(R.string.is_connected), Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if(permissionCheck==0){
                ...
                Toast.makeText(this, "Termina try", Toast.LENGTH_SHORT).show();
            }
